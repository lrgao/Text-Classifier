...
class BertForSequenceClassification(BertPreTrainedModel):
        ...
        if is_training:
            if labels is not None:
                if self.num_labels == 1:
                    ...
                    # loss = loss_fct(torch.sigmoid(logits.view(-1, self.num_labels)), labels.float())
    ...
    def infer(
        ...
        return loss, torch.sigmoid(logits.view(-1, self.num_labels))  # (loss), logits, (hidden_states), (attentions)
